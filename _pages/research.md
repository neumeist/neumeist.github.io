...
: Traditionally, searches for the resonant or nonresonant production of new physics at high invariant masses of dilepton events have mostly focused on final states inclusive in the number of b-tagged jets. No significant sign of new physics has been observed in these searches so far. We recently started a new search that can improve the sensitivity to new physics in dimuon + b jet events.  We study the impact of contact interactions involving two leptons (electrons or muons) and two b-quarks on the high-mass dilepton region at the LHC. The idea is based on [1](https://arxiv.org/abs/1805.11402), 
