...
- **Di-Higgs analysis:**
We performe a search for a BSM resonance $X$ decaying to a pair of SM Higgs bosons in the channel $X \to HH \to WW\gamma\gamma$ using Run 2 data.
The purity and branching fraction of the final state are key features in the study of di-Higgs boson production. In this analysis, we study the $WW\gamma\gamma$ final state, where the $H \to WW$ decay has the second largest branching fraction (∼21.4%) among all Higgs boson decay modes and the $H → \gamma\gamma$ decay provides a relatively clean final state that can be fully reconstructed with excellent mass resolution. The total branching fraction of $HH \to WW\gamma\gamma$ is about 0.097%.
We explore two dominant decay modes of the WW system: fully hadronic and semileptonic. This analysis represents the first LHC study targeting this
final state with the WW system reconstructed in the FH decay mode, as well as considering the boosted topology for all WW decay modes. All relevant topologies of both WW semileptonic
(SL) and fully hadronic (FH) decays are considered.
